...
1. What is the DOM?
The Document Object Model (DOM) represents the document as nodes and objects like a tree with branches. So that programming languages can connect to the page. The DOM is also dynamic meaning it can be changed live.

2. What is an event?
Events are actions or occurrences that happen in the system you are programming, which the system tells you about so you can respond to them in some way if desired.

3. What is an event listener?
Block of code that will be run when the event fires.
 
4. Why would we convert a NodeList into an Array?
In order to use some advanced array methods.

5. What is a component?
 It is a modular piece of code.
